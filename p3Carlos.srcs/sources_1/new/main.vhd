...
type ROM_MEMORY_array is array(0 to 255) of std_logic_vector(15 downto 0);
    constant Content: ROM_MEMORY_array:=(
		  ...
		  -- Cargar 100 en el registro checar si es menor apunto a la parte de 3 seungods dependiendo del resultado apunto a
		  -- a los segundos, y que esten harcodeados los 5 segundos. si es mayo que 100 salto al dos y hago esos ciclos
		  ...
		  159=> "1101001000000000", -- send r3 to display 
		  160=> "1100100100000000", -- COMPARER LEDS
		  
		  161=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  162=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  
		  163=> "1100011100000000", -- Aumenta uno en LEDS OUT
		  ...
		  188=> "1100011100000000", -- Aumenta uno en LEDS OUT
		  
		  189=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  190=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  191=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  192=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  193=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  194=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  
		  195=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  196=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  
		  -- FIN CUARTO SEGUNDO
		  
		  197=> "1100011100000000", -- Aumenta uno en LEDS OUT
		  
		  198=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  199=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  200=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  201=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  202=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  203=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  204=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  205=> "1100000100100110", -- JARL LLamando a el programa de un segundo y retorna aqui mas uno de pc
		  
		  -- FIN QUINTO SEGUNDO
		  
		  206=> "1100100000000000", -- CLEAR LEDS
		  
		  ---- AQUI SE SALE DEL CICLO AL NUEVO CICLO DEL N
		  207=> "1011000100100011", -- LOAD DIRECCION MEMORIA 35 in r2
		  208=> "1101001000000000", -- send r3 to display 
		
		  209=> "0000001000000000", -- send r3 to acc	 
		  210=> "1000011100000000", -- SUBTRACR R2 - acc and store in r4
		  211=> "1101001000000000", -- send r3 to display 
		
		  212=> "1100001010011010", -- BNZ reg 4 SALTO A 154
		  ...
		  213=> "1101000000000000", -- send r1 to display
		  214=> "1111000000000000", -- FIN DEL PROGRAMA
...
type estados is (init, fetch, decode, load,load1,load2, operation,operation1,endprog,send, intruJMP,jmp,jalr,jalr2,comp,bnc,bnz,bnv,move,bs,ret, bnz2, bs2, leds, leds_clear, cmp_leds, cmp_leds2,cmp_leds6,cmp_leds3,cmp_leds4,cmp_leds5);
...
case actual is 
  ...
  --          JUMP            --   -- FUNCIONA
    ...
    when leds=>
    leds_sig <= leds_sig(3 downto 0) & '1';
    sig:=fetch;
    ---- LEDS CLEAR
    when leds_clear=>
    leds_sig <= "00000";
    ...
    ---- LEDS CMP
    when cmp_leds=> -- Comparacion 100
    enable_cmp <= '1';
    dato_cmp_1 <= "000000001100100"; -- 100
    dato_cmp_2 <= regA;
    sig:=cmp_leds2;
    
    when cmp_leds2=> -- Comparacion mayor 100
    if(gt_cmp = '1')then
        enable_cmp <= '0';
        pcreg:= "10111010"; -- Memoria 186 que manda a dos seugndos
        sig:=fetch;
    elsif(eq_cmp = '1')then 
        enable_cmp <= '0';
        enable_cmp <= '0';
        ...
        enable_cmp <= '1';
        dato_cmp_1 <= "0000000000111100"; -- 60
        dato_cmp_2 <= regA;
        pcreg:= "10111010"; -- Memoria 186 que manda a dos seugndos
        sig:=cmp_leds3;
    end if;  
    when cmp_leds2=> -- Comparacion 100 entre 60
    if(gt_cmp = '1')then
        enable_cmp <= '0';
        pcreg:= "10111010"; -- Memoria 186 que manda a dos seugndos
        sig:=fetch;
